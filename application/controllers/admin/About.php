...
class About extends CI_Controller {
	...
	public function create() {
        $data = array();
        $data['title'] = "Create About || Sunset Bali Adventure";
        ...
        $this->load->view('admin/about/v_create', $data);
    }

    public function store() {
        try {
            $data = array(
                'title' => $this->input->post('titleNew'),
                'sumary' => $this->input->post('summaryNew'),
                'state' => 1
            );
            $this->m_about->store($data);
            $this->session->set_flashdata('status', 'Success create about');
    ...
    public function destroy() {
        try {
            $this->m_about->destroy($this->input->post('id_about'));
    ...
    public function edit($id) {
        $data = array();
        $data['title'] = "Edit About || Sunset Bali Adventure";
        ...
        $data['about'] = $this->m_about->getAbout($id);
        $this->load->view('admin/about/v_edit', $data);
    }
