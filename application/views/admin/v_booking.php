            ...
            <div id="ui-view">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="post" class="form-horizontal" id="formAddPackage">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="nameService">Service</label>
                                        <div class="col-md-9">
                                            <select class="form-control" id="service">
                                                <option>Survival</option>
                                                <option>Arum jeram</option>
                                            </select>
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="numberOfPeople">People</label>
                                        <div class="col-md-9">
                                            <input type="number" id="numberOfPeople" name="numberOfPeople" class="form-control" placeholder="Number of people...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="minimumPeople">Min. people</label>
                                        <div class="col-md-9">
                                            <input type="number" id="minimumPeople" name="minimumPeople" class="form-control" placeholder="Minimum people...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" id="duration" name="duration" class="form-control" placeholder="Duration (hour)...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                            
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="packageType">Package type</label>
                                        <div class="col-md-9">
                                            <input type="text" id="packageType" name="packageType" class="form-control" placeholder="Package type...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="priceIdr">Price IDR</label>
                                        <div class="col-md-9">
                                            <input type="text" id="priceIdr" name="priceIdr" class="form-control" placeholder="IDR...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="priceIdr">Price USD</label>
                                        <div class="col-md-9">
                                            <input type="text" id="priceUsd" name="priceUsd" class="form-control" placeholder="USD...">
                                            <span class="hasErrorText"></span>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" id="buttonAddBookingNew" class="btn btn-success" data-toggle="modal" data-target="#modalAddPackage" style="margin-bottom: 10px;"><i class="fa fa-plus"></i>&nbsp; Add booking</button>
                                <?php 
                                    if(count($booking) > 0) {
                                ?>
                                    <table class="table table-responsive-sm table-hover" id="tableListBooking">
                                        <thead>
                                        <tr>
                                            <th>Package</th>
                                            <th>Price</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary" onclick="openFormUpdateBooking(<?php echo $row->id_booking; ?>)"><i class="fa fa-pencil"></i>&nbsp; Edit</button>
                                                        <button type="button" class="btn btn-danger" onclick="confirmDeleteBooking(<?php echo $row->id_booking; ?>)"><i class="fa fa-trash"></i>&nbsp; Delete</button>
                                                    </td>
                                                </tr>
                                            <?php 
                                                }
