            ...
            <div id="ui-view">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" id="buttonAddPackageNew" class="btn btn-success" data-toggle="modal" data-target="#modalAddPackage" style="margin-bottom: 10px;"><i class="fa fa-plus"></i>&nbsp; Add package</button>
                                <?php 
                                    if(count($packages) > 0) {
                                ?>
                                    <table class="table table-responsive-sm table-hover" id="tableListPackages">
                                        <thead>
                                        <tr>
                                            <th>Service</th>
